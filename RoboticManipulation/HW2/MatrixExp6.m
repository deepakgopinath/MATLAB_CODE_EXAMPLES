...
%Example
%input = [0    0.7071    0.7071    1.0000    2.0000    3.0000 ]'
%output =
% 0.5403   -0.5950    0.5950    1.1665
% 0.5950    0.7702    0.2298    2.4043
% -0.5950    0.2298    0.7702    2.5957
%  0         0         0    1.0000
T = [];
