...
function [ output_args ] = timeDomAC( file, windowSize, hopSize )
...
etaArray = 0:1:windowSize-1; %row vector; We will calculate only for positive values and then mirror it to form the complete matrix
i = 1;
count = 1;
