...
% num_neuron_layers = [5,20,1]; %specify net structure by a vector. Num of elements is the num of layers.
% % ith element is the num of units in the ith layer. 

% [final_w_nn1, final_b_nn1, error_nn1] = neural_network(num_neuron_layers, training_nn1, test_nn1, 150, 3.5);
% plot_error(error_nn1, test_nn1, final_w_nn1, final_b_nn1, 1,2, curr_nn,'theta new'); %x,y vs x'
% save('5_20_15_1_ns1_LM_ds0_theta.mat', 'final_w_nn1', 'final_b_nn1', 'error_nn1');
% 
% % %ANN 2 - FOR DELTAY LEARNING
% % % 
% [final_w_nn2, final_b_nn2, error_nn2] = neural_network(num_neuron_layers, training_nn2, test_nn2, 250, 4.0);
% plot_error(error_nn2, test_nn2, final_w_nn2, final_b_nn2, 1,2, curr_nn,'next state y');
% save('5_202016108_1_ns2_LM_ds0.mat', 'final_w_nn2', 'final_b_nn2', 'error_nn2');
% % 
% % num_neuron_layers = [6,20,10,10,8,1]; 
% [final_w_nn3, final_b_nn3, error_nn3] = neural_network(num_neuron_layers, training_nn3, test_nn3, 250, 3.5);
plot_error(error_nn3, test_nn3, final_w_nn3, final_b_nn3, 1,3, curr_nn, 'next state z');
% save('5_202016108_1_ns3_LM_ds0.mat', 'final_w_nn3', 'final_b_nn3', 'error_nn3');
% % 
% 
